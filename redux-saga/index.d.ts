...
export interface SagaMiddleware<C = {}> extends Middleware {
  ...
  run<T1, T2>(saga: Saga2<T1, T2>, arg1: T1, arg2: T2): Task;
  run<T1, T2, T3>(saga: Saga3<T1, T2, T3>, arg1: T1, arg2: T2, arg3: T3): Task;
  run<T1, T2, T3, T4>(
...
export function runSaga<A, S>(options: RunSagaOptions<A, S>, saga: Saga0): Task;
